...
const Info = ()=>{
    ...
    const {tecno_relief} = resources[language];

    return(
        <section className='seccion-info-container'>
            <div className='row m-0 seccion-info'>
                <div className="col-10 m-0 col-md-12">
                    <p>
                    {language === 'en' ? <p className='seccion-info-en'>{tecno_relief.spanInfo3}<strong >{tecno_relief.spanInfo}</strong>{tecno_relief.info}<strong>{tecno_relief.spanInfo2}</strong></p> : <p className='seccion-info-es'><strong >{tecno_relief.spanInfo}</strong>{tecno_relief.info}<strong>{tecno_relief.spanInfo2}</strong></p>}
                    </p>
                </div>
            </div>
            <div className='row m-0 seccion-proyects'>
                <div className="col-12 col-md-12 m-0 d-flex">
                <p>
                    <a href="#servies">{tecno_relief.proyects} <svg className='arrow' xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
