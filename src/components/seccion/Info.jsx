...
const Info = ()=>{
    ...
    const {info, proyects,spanInfo , spanInfo2} = resources[language];

    return(
        <section className='seccion-info-container'>
            <div className='seccion-info'>
                <p><span className='seccion-span'>{spanInfo}</span>{info} <span className='seccion-span'>{spanInfo2}</span></p>
            </div>
            <div className='seccion-proyects'>
                <p><a href="">{proyects}</a></p> 
                <svg className='arrow' xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
